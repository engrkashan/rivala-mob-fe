            ...
            child: Row(
              ...
              children: [
                if (icon != null && iconPosition == IconPosition.left)
                  Padding(
                    padding: EdgeInsets.only(left: cornerIcon == true ? 10.0 : 8.0), // ✅ Adjust for corners
                    child: Icon(icon, color: fontColor, size: iconSize),
                  ),
                if (image != null && iconPosition == IconPosition.left)
                  Padding(
                    padding: EdgeInsets.only(left: cornerIcon == true ? 10.0 : 8.0),
                ...
                if (icon != null && iconPosition == IconPosition.right)
                  Padding(
                    padding: EdgeInsets.only(right: cornerIcon == true ? 10.0 : 8.0), // ✅ Adjust for corners
                    child: Icon(icon, color: fontColor, size: iconSize),
                  ),
                if (image != null && iconPosition == IconPosition.right)
                  Padding(
                    padding: EdgeInsets.only(right: cornerIcon == true ? 10.0 : 8.0),
                    child: Image.asset(image!, height: iconSize, width: iconSize),
                  ),
              ],
            ),
...
class Mybutton2 extends StatelessWidget {
  ...
  const Mybutton2({super.key, this.buttonText, this.ontap, this.mbot, this.hpad, this.buttonText2, this.ontap2, this.useCustomFont=false, this.bgColor, this.borderColor, this.fontColor});
