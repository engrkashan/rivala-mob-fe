...
import '../screens/main_menu_flow/menu/orders/guest_accout_login/login_guest_account.dart';
          ...
          Bounce_widget(
            ontap: onCloseIconTap ??
                () {
                  ...
                  if (currentRoute.contains('SignIn') ||
                      currentRoute.contains('CreateAccount') ||
                      currentRoute.contains('VerifyAccount')) {
                    Get.to(() => const LoginGuestAccount());
                  } else {
                    Get.back();
                  }
                },
