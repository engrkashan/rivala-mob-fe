              ...
              child: Consumer<ThemeProvider>(builder: (context, theme, _) {
                return ListView(
                  ...
                  children: [
                    ...
                    color_palette_row(
                        'Header Color', kheader, _kheaderController, (color) {
                      setState(() {
                        kheader = color;
                    ...
                    SizedBox(height: 15),
                    color_palette_row(
                        'Body Text Color', kbody, _kbodyController, (color) {
                      setState(() {
                        kbody = color;
                    ...
                    SizedBox(height: 15),
                    color_palette_row(
                        'Button Color', kbutton, _kbuttonController, (color) {
                      setState(() {
                        kbutton = color;
                    ...
                    SizedBox(height: 15),
                    color_palette_row('Button Text Color', kbuttonText,
                        _kbuttonTextController, (color) {
                      setState(() {
                        kbuttonText = color;
