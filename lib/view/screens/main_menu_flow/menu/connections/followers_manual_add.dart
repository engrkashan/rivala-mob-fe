...
class _FollowersManualAddState extends State<FollowersManualAdd> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar:
            simpleAppBar(context: context,title: widget.title ?? 'Followers', centerTitle: true),
        body: Column(
...
class manual_add_row extends StatelessWidget {
  ...
  const manual_add_row({
    ...
    this.size1,
    this.size2,
    this.isButton=true, this.weight2, this.mbot, this.ontap,
  });
      ...
      widget: Row(
        children: [
          ...
          Expanded(
            ...
            text1:isFollowing == true ? 'Following' :text1??  'Follow',
            text2: text2 ?? 'Nutrition Rescue',
            size1: size1 ?? 11,
            size2: size2 ?? 14,
