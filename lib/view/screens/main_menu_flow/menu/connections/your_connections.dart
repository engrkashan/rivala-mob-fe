...
class _YourConnectionsState extends State<YourConnections> {
  ...
  Widget build(BuildContext context) {
     List<Map<String, dynamic>> mainMenuItems = [
    {
      ...
      'delay': 100,
      'ontap': () => 
       Navigator.of(context).push(CustomPageRoute(page:FollowersManualAdd()),)
      // Get.to(
      //       () => FollowersManualAdd(),
    ...
    },
    {
      ...
      'delay': 400,
      'ontap': () => 
         Navigator.of(context).push(CustomPageRoute(page:Squads()),)
      ...
      'delay': 550,
      'ontap': () =>
         Navigator.of(context).push(CustomPageRoute(page:ConnectionMesg()),)
