                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        row_widget(
                          onTap: () {
                                 Navigator.of(context).push(CustomPageRoute(page:EditExistingProducts(hasProducts: false,)),);
        ...
        children: [
          ...
          if (isActive) ...{
            ...
            MyText(
              ...
              paddingTop: 15,
              onTap: (){
                Navigator.of(context).push(CustomPageRoute(page:EditExistingProducts()),);
