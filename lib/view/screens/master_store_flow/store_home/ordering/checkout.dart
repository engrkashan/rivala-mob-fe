              ...
              bodyWidget: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ContainerAppbar(title: 'My Bag (2 Items)'),
                  ),
                  Padding(
...
class bag_items_row extends StatelessWidget {
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            text1: title ?? 'Blue Floral Short',
            text2: showAmount == true ? '' : desc ?? 'Apollo and Sage',
            mBottom: 2,
            size2: 10,
            size1: 15,
            useCustomFont: true,
...
class add_itemss extends StatefulWidget {
  const add_itemss({super.key});

  @override
  State<add_itemss> createState() => _add_itemssState();
}

class _add_itemssState extends State<add_itemss> {
  int quantity = 1;
